...
// Source code: https://github.com/Shrimpey/UltimateOutline/blob/master/UltimateOutline.shader
// Tutorial on how to set up this shader: https://www.youtube.com/watch?v=00qMZlacZQo
