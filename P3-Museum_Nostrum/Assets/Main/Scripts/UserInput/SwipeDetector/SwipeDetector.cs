...
public class SwipeDetector : MonoBehaviour
{
    ...
    private void Update()
    {
        foreach (Touch touch in Input.touches)
        {
            ...
            if (/*!dragManager.WasDragging() &&*/ touch.phase == TouchPhase.Ended)
            {
                fingerDownPosition = touch.position;
                DetectSwipe();
            }
    ...
    //------------------------ customized code -----------------------------
    //Todo: don't forget drag manager.
        //private DragManager dragManager;    // to access IsDragging()
    void Awake()
    {
        //dragManager = GetComponent<DragManager>();  //used to call dragManager.WasDragged();
        //get DataLogger
