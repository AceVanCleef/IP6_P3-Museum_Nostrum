...
public class ReplayManager : MonoBehaviour
{
    ...
    public GameObject welcomeMessageGUI;
    public GameObject ReplayerMessage;
    public TextMeshProUGUI ReplayerMessageText;
    ...
    IEnumerator Start()
    {
        ...
        welcomeMessageGUI.SetActive(false);
    ...
    private IEnumerator showReplayerMessage(string message)
    {
        ...
        ReplayerMessage.SetActive(true);
        ReplayerMessageText.text = message;
        yield return new WaitForSeconds(messageDuration);
        ReplayerMessage.SetActive(false);
    }
}
